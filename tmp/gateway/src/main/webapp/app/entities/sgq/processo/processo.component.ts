...
export class ProcessoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.processoService
      ...
      .subscribe(
        (res: HttpResponse<IProcesso[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  registerChangeInProcessos(): void {
    this.eventSubscriber = this.eventManager.subscribe('processoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProcesso[] | null, headers: HttpHeaders, page: number): void {
