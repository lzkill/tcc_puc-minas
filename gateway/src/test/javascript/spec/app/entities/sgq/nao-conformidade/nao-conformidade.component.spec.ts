...
import { NaoConformidadeComponent } from 'app/entities/sgq/nao-conformidade/nao-conformidade.component';
...
describe('Component Tests', () => {
  describe('NaoConformidade Management Component', () => {
    let comp: NaoConformidadeComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(NaoConformidadeComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.naoConformidades && comp.naoConformidades[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
