...
import com.xpto.consultoria.service.AnaliseConsultoriaQueryService;
...
/**
 * REST controller for managing {@link com.xpto.consultoria.domain.AnaliseConsultoria}.
 */
@RestController
@RequestMapping("/api")
public class AnaliseConsultoriaResource {
    ...
    private static final String ENTITY_NAME = "consultoriaAnaliseConsultoria";
