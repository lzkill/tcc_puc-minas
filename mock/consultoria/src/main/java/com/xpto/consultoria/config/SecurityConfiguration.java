package com.xpto.consultoria.config;
...
import com.xpto.consultoria.security.jwt.JWTConfigurer;
import com.xpto.consultoria.security.jwt.TokenProvider;
...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		...
		http.csrf().disable().exceptionHandling().authenticationEntryPoint(problemSupport)
				...
				// 'unsafe-inline' 'unsafe-eval' https://storage.googleapis.com; style-src
				...
				// Custom rules
				.antMatchers("/api/**").permitAll().antMatchers("/management/**").permitAll()
