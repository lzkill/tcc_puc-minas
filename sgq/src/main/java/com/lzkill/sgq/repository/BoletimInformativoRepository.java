...
public interface BoletimInformativoRepository extends JpaRepository<BoletimInformativo, Long>, JpaSpecificationExecutor<BoletimInformativo> {
    ...
    @Query(value = "select distinct boletimInformativo from BoletimInformativo boletimInformativo left join fetch boletimInformativo.categorias",
    ...
    @Query("select distinct boletimInformativo from BoletimInformativo boletimInformativo left join fetch boletimInformativo.categorias")
    List<BoletimInformativo> findAllWithEagerRelationships();

    @Query("select boletimInformativo from BoletimInformativo boletimInformativo left join fetch boletimInformativo.categorias where boletimInformativo.id =:id")
